    ...
    *,
        ...
        construction_specs.append(
            {
                ...
                "description": "Excel-style variant: floating leg offsets coupon plus principal PV.",
    ...
    return {
        ...
        "model_notes": [
            ...
            "ACT/365 and annual compounding are used for this educational core model.",
        ],
...
def _build_warnings(constructions: Sequence[Mapping[str, Any]]) -> list[str]:
    ...
    for construction in constructions:
        ...
        if spread > 1000:
            warnings.append(
                f"{construction['name']}: fair spread is above 1000 bps; "
                "check whether principal should be included in the hedge target."
            )
    return warnings
